...
def validate(model, args, test_loader, device, total_iter, where_to_write, vis_dir=None):
    with torch.no_grad():
        ...
        utils.log_normal_errors(metrics, where_to_write, first_line='total_iter: {}'.format(total_iter),logger=None)
        # custom func neptune
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', default='exp0111_test', type=str, help='experiment name')
